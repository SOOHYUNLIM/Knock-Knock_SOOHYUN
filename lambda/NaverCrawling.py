...
def lambda_handler(event, context):
    ...
    addLowPrice = 'insert into tbl_lowprice (pno, category, title, price, fee, image, link) values(%s, %s, %s, %s, %s, %s, %s)'
    ...
    for pick in pickList:
        ...
        curs.execute(addLowPrice, (pick['pno'], '', item['title'], item['price'], item['fee'], item['image'], item['link']))
